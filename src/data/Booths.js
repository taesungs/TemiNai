...
export const booths = [
    ...
    },
    {
      ...
      poi: "intelligent robot", // 시작점
      name: "지능형 로봇",
      description: "AI, 교육용 로봇 제작과 조종, 보행 로봇 체험을 할 수 있습니다.",
      style: { top: "29%", left: "46%", width: "14%", height: "21%" },
    },
    {
      id: "new energy business",
      poi: "new energy business",
      name: "에너지 신사업",
